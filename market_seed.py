...
# Manual market stock fills useful gaps in the public item catalog. These are
# user-tunable seed entries for practical server economy needs: listing_count
# is how many exchange listings are created, stack_size is units per listing,
# and unit_price is the price before the UI multiplier is applied.
MANUAL_SEED_ITEMS = [
    {
    ...
    {
        "template_id": "HealthPack_Channeled_4",
        "display_name": "Healkit Mk6",
        "kind": "consumable",
        "category": "items/utility/consumables/utility",
        "listing_count": 50,
        "stack_size": 20,
        "unit_price": 175,
    },
    {
        "template_id": "AntiRadiationPill",
        "display_name": "Iodine Pill",
        "kind": "consumable",
        "category": "items/utility/consumables/utility",
        "listing_count": 50,
        "stack_size": 20,
    ...
    {
        "template_id": "SaphoJuice",
        "display_name": "Sapho Juice",
        "kind": "consumable",
        "category": "items/utility/consumables/utility",
        "listing_count": 10,
        "stack_size": 20,
    ...
    {
        "template_id": "SpiceAddictionConsumable_04",
        "display_name": "Melange Spiced Wine",
        "kind": "consumable",
        "category": "items/utility/consumables/utility",
        "listing_count": 50,
        "stack_size": 20,
    ...
    {
        "template_id": "PortableLight",
        "display_name": "Personal Light",
        "kind": "utility",
        "category": "items/utility/utilitytools/utility",
        "listing_count": 10,
        "stack_size": 1,
        "unit_price": 2500,
    },
    {
        "template_id": "BlankSinkChart",
        "display_name": "Blank Sinkchart",
        "kind": "cartography",
        "category": "items/utility/cartographytools/sinkchart",
        "listing_count": 15,
        "stack_size": 20,
        "unit_price": 1100,
    },
...
def summary(plan, price_multiplier):
    result = {
        ...
        "resource_listings": 0,
        "ammunition_listings": 0,
        "consumable_listings": 0,
        "utility_listings": 0,
        "cartography_listings": 0,
        "resource_units": 0,
        "special_boosted_listings": 0,
        "price_multiplier": int(price_multiplier),
    }
    for row in plan:
        result.setdefault(f"{row['kind']}_listings", 0)
...
SELECT
    ...
    COUNT(*) FILTER (WHERE seed_kind = 'ammunition') AS ammunition_listings,
    COUNT(*) FILTER (WHERE seed_kind = 'consumable') AS consumable_listings,
    COUNT(*) FILTER (WHERE seed_kind = 'utility') AS utility_listings,
    COUNT(*) FILTER (WHERE seed_kind = 'cartography') AS cartography_listings,
